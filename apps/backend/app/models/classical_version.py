...
class ClassicalVersion(BaseModel):
    ...
    edition_type: Mapped[Optional[str]] = mapped_column(String(100), nullable=True, comment="版本类型 (刻本/抄本/石印本/排印本/影印本/其他)")
    volume_count: Mapped[Optional[int]] = mapped_column(Integer, nullable=True, comment="卷数")
    ...
    image_url: Mapped[Optional[str]] = mapped_column(String(2000), nullable=True, comment="书影链接")
    ...
    citation_note: Mapped[Optional[str]] = mapped_column(Text, nullable=True, comment="引用说明")
    academic_note: Mapped[Optional[str]] = mapped_column(Text, nullable=True, comment="学术备注")
