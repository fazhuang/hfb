...
class Citation(BaseModel):
    ...
    target_type: Mapped[str] = mapped_column(String(50), nullable=False, comment="被引用的系统对象类型 (Variant/AcademicRelation/Passage)")
    target_id: Mapped[str] = mapped_column(String(36), nullable=False, comment="被引用的对象UUID")
