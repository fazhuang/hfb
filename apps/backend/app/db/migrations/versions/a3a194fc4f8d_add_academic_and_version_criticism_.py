...
down_revision: str | None = "291a1dce8d65"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_academic_entities_name"), "academic_entities", ["name"], unique=True
    )
    op.create_table(
        "source_refs",
        sa.Column(
            ...
            nullable=False,
            comment="物理书名/文献名/论文名",
        ),
        sa.Column(
            "author", sa.String(length=200), nullable=True, comment="作者/编校者"
        ),
        sa.Column(
            "edition_info",
            sa.String(length=500),
            nullable=True,
            comment="版本信息/出版社/刊刻年代",
        ),
        sa.Column(
            "page_location",
            sa.String(length=200),
            nullable=True,
            comment="文献内的定位：卷/页/行/栏",
        ),
        sa.Column(
            "url",
    ...
    op.create_table(
        "academic_relations",
        sa.Column(
            "source_entity_id", sa.String(length=36), nullable=False, comment="源实体ID"
        ),
        sa.Column(
            "target_entity_id", sa.String(length=36), nullable=False, comment="靶实体ID"
        ),
        sa.Column(
            "relation_type",
        ...
        sa.ForeignKeyConstraint(
            ["source_entity_id"], ["academic_entities.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["target_entity_id"], ["academic_entities.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        ...
        sa.Column("is_deleted", sa.Boolean(), server_default="false", nullable=False),
        sa.ForeignKeyConstraint(
            ["relation_id"], ["academic_relations.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        "evidences",
        sa.Column(
            "description", sa.Text(), nullable=False, comment="证据内容概述/考证逻辑"
        ),
        sa.Column(
            "evidence_level",
            sa.Enum("LEVEL_1", "LEVEL_2", "LEVEL_3", "LEVEL_4", name="evidencelevel"),
            nullable=False,
            comment="学术证据力等级",
        ),
        sa.Column(
        ...
        sa.Column(
            "creator_id", sa.String(length=36), nullable=True, comment="创建录入人"
        ),
        sa.Column("id", sa.String(length=36), nullable=False),
        sa.Column(
            "created_at",
        ...
        sa.ForeignKeyConstraint(
            ["source_passage_id"], ["passages.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(
            ["source_ref_id"], ["source_refs.id"], ondelete="RESTRICT"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_table(
        "sentences",
        sa.Column(
            "passage_id", sa.String(length=36), nullable=False, comment="所属段落 ID"
        ),
    ...
    op.create_index(
        op.f("ix_sentences_passage_id"), "sentences", ["passage_id"], unique=False
    )
    op.create_table(
        "citations",
        sa.Column(
        ...
        sa.Column(
            "evidence_id", sa.String(length=36), nullable=False, comment="支撑证据ID"
        ),
    ...
    op.create_index(
        "idx_citation_target", "citations", ["target_type", "target_id"], unique=False
    )
    op.create_table(
        "relation_evidences",
    ...
    op.create_table(
        "tokens",
        sa.Column(
            "sentence_id", sa.String(length=36), nullable=False, comment="所属断句 ID"
        ),
        sa.Column(
            "char_text",
            sa.String(length=50),
    ...
    op.create_index(
        "idx_token_lookup", "tokens", ["sentence_id", "position"], unique=False
    )
    op.create_table(
        "variants",
        sa.Column(
            ...
            sa.String(length=36),
            nullable=False,
            comment="基准版本的Token ID",
        ),
        sa.Column(
            "compare_token_id",
            sa.String(length=36),
            nullable=True,
            comment="比对版本的Token ID",
        ),
        sa.Column(
            "variant_type",
            sa.Enum(
        ...
        sa.ForeignKeyConstraint(
            ["compare_token_id"], ["tokens.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_variants_base_token_id"), "variants", ["base_token_id"], unique=False
    )
    op.create_index(
        op.f("ix_variants_compare_token_id"),
        "variants",
        ["compare_token_id"],
        unique=False,
    )
