...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_classical_versions_work_title", "classical_versions", ["work_title"]
    )
    op.create_index(
        "ix_classical_versions_review_status", "classical_versions", ["review_status"]
    )
    op.create_index(
        "ix_classical_versions_is_deleted", "classical_versions", ["is_deleted"]
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_classical_versions_review_status", table_name="classical_versions"
    )
