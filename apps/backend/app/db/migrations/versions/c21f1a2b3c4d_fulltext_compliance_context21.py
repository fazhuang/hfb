...
def upgrade() -> None:
    ...
    with op.batch_alter_table("documents") as batch_op:
        batch_op.add_column(sa.Column(
            "copyright_status", sa.String(50), nullable=False,
        ...
        batch_op.add_column(sa.Column(
            "license_type", sa.String(100), nullable=True,
            comment="许可类型: CC-BY|CC-BY-NC|CC-BY-SA|CC0|custom",
        ))
        batch_op.add_column(sa.Column(
            "authorization_basis", sa.String(200), nullable=True,
            comment="授权依据 (license URL / agreement ref / basis statement)",
        ))
        batch_op.add_column(sa.Column(
            "review_status", sa.String(50), nullable=False,
            server_default="pending_review",
            comment="审核状态: pending_review|under_review|approved|rejected",
        ))
        batch_op.add_column(sa.Column(
            "reviewed_by", sa.String(36), nullable=True,
            comment="审核人 user ID",
        ))
        batch_op.add_column(sa.Column(
        ...
        batch_op.add_column(sa.Column(
            "rag_enabled", sa.Boolean(), nullable=False,
            server_default="false",
            comment="是否允许进入 RAG",
        ))
        batch_op.add_column(sa.Column(
            "content_checksum", sa.String(64), nullable=True,
            comment="全文 SHA-256 checksum",
        ))
        batch_op.add_column(sa.Column(
            "source_name", sa.String(200), nullable=True,
            comment="摄入来源名称",
        ))
        batch_op.add_column(sa.Column(
        ...
        batch_op.add_column(sa.Column(
            "withdraw_reason", sa.Text(), nullable=True,
            comment="撤回原因",
        ))
    ...
    op.create_table(
        ...
        sa.Column("authorization_basis", sa.String(200), nullable=True, comment="授权依据"),
        ...
        sa.Column("reviewed_by", sa.String(36), nullable=True, comment="审核人 user ID"),
        sa.Column("reviewed_at", sa.DateTime(timezone=True), nullable=True, comment="审核时间"),
        sa.Column("checksum", sa.String(64), nullable=True, comment="SHA-256 of full-text content"),
        sa.Column("result_entity_type", sa.String(50), nullable=True, comment="结果实体类型"),
        sa.Column("result_entity_id", sa.String(36), nullable=True, comment="结果实体 ID"),
